...
powershell -Command "try { $r=Invoke-WebRequest -Uri 'http://localhost:8000/welcome-page-index.html' -UseBasicParsing; exit 0 } catch { exit 1 }"
if errorlevel 1 goto waitloop

REM Open welcome page in default browser
start "" "http://localhost:8000/welcome-page-index.html"
